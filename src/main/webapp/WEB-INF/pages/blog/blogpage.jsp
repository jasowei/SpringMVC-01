    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <%--<a class="navbar-brand" href="#">--%>
                <img style="width: 50px ;height: 50px" alt="JASO" src="../../../weibo.jpg">
            <%--</a>--%>
        </div>

        <div class="collapse navbar-collapse" id="nav-1">
            <ul class="nav navbar-nav">
                <li class="active"><a href="#">${applicationScope.loginUser.name}</a></li>

                <li><a href="/addblog">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;新建博客 <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a></li>
            </ul>

            <form class="navbar-form navbar-left" action="/search" id="f">
                <div class="form-group">
                    <input type="hidden" name="userId" value="${applicationScope.loginUser.id}">
                    <input name="content" type="text" class="form-control" placeholder="输入搜索的内容">
                </div>
